...
function page() {
  return (
    <div>
      {" "}
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Installment Loan">
              ...
              <div className="row">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6">
                  <div className="services-five__single">
                    ...
                    <h3 className="services-five__title">
                      <Link href="health-insurance">Daily Payments</Link>
                    </h3>
                    <Link
                ...
                <div className="col-xl-4 col-lg-6 col-md-6">
                  <div className="services-five__single">
                    ...
                    <h3 className="services-five__title">
                      <Link href="family-insurance">Automatic Withdrawals</Link>
                    </h3>
                    <Link
